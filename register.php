                                ...
                                <div class="form-bottom">
                                    <form role="form" action="" method="post" class="login-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="form-password" placeholder="Nama lengkap..." class="form-password form-control" id="form-password">
                                        </div>
                                        <div class="form-group">
                                            <label class="sr-only" for="form-email">E-mail</label>
                                            <input type="text" name="form-password" placeholder="E-mail..." class="form-password form-control" id="form-password">
                                        </div>
                                        <div class="form-group">
                                            <label class="sr-only" for="form-nomerhp">Nomer HP</label>
                                            <input type="text" name="form-password" placeholder="Nomer HP..." class="form-password form-control" id="form-password">
                                        </div>
